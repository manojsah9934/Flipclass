<?php
	...
	if (isset($_POST['reg_user'])) {
		...
		if (count($errors) == 0) {
			...
			$query = "INSERT INTO teacheregistration(fname, lname, uname, email, gender, password) 
		...
		<div class="wrapper" style="background-image: url('images/bg-registration-form-1.jpg');">
			<div class="inner">
				...
				<form action = "teacher_registration.php" method = "post">
					...
					<center> <b> Already Have account? </b> <a href="teacher_login.php" class = "ca">login</a> </center>
				</form>
			</div>
		</div>
